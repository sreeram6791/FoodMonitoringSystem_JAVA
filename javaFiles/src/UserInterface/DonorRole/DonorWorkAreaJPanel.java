...
public class DonorWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public DonorWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, DonorOrganization organization, Enterprise enterprise, EcoSystem business,DB4OUtil dB4OUtil) {
        initComponents();
...
//        populateRequestTable();
    ...
    private void initComponents() {
        ...
        add(exit, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 180, 30, 30));
        ...
        add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 170, 150, 40));

        amountjTextField.setFont(new java.awt.Font("Ubuntu", 0, 12)); // NOI18N
        amountjTextField.setForeground(new java.awt.Color(1, 1, 1));
        amountjTextField.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        amountjTextField.setBorder(null);
        amountjTextField.setCursor(new java.awt.Cursor(java.awt.Cursor.TEXT_CURSOR));
        amountjTextField.setMinimumSize(new java.awt.Dimension(20, 17));
        amountjTextField.setOpaque(false);
        add(amountjTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 180, 200, 30));

        nameTextField.setFont(new java.awt.Font("Ubuntu", 0, 12)); // NOI18N
        nameTextField.setForeground(new java.awt.Color(1, 1, 1));
        ...
        nameTextField.setMinimumSize(new java.awt.Dimension(20, 17));
        nameTextField.setOpaque(false);
        add(nameTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 110, 200, 30));

        jLabel11.setFont(new java.awt.Font("URW Gothic L", 0, 14)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(254, 254, 254));
        jLabel11.setText("Name");
        add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 100, 150, 40));
    ...
    private void exitMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_exitMouseReleased
         ...
         try{
                if(amountjTextField.getText().isEmpty() || nameTextField.getText().isEmpty()){
                    throw new Exception();
                }
             
                int amount = Integer.parseInt(amountjTextField.getText());
                account.addFunds(amount);
                JOptionPane.showMessageDialog(null, "Thank you, for your contribution of $"+amount+". ");
            }
