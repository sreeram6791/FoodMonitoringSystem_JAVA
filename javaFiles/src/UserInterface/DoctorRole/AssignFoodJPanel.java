 ...
 * @author rama
 */
public class AssignFoodJPanel extends javax.swing.JPanel {
     ...
     */
    public AssignFoodJPanel(JPanel container,Patient patient,UserAccount userAccount,DoctorOrganization organization,Enterprise enterprise,FoodDirectory  foodDirectory,EcoSystem system, DB4OUtil dB4OUtil){
        initComponents();
...
//        this.foodDirectory = foodDirectory;
    ...
    private void initComponents() {
        ...
        add(Forward, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 280, -1, 30));
        ...
        jLabel2.setText("Prescribe Food");
    ...
    private void ForwardMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ForwardMouseReleased
        ...
        DefaultTableModel dtm = (DefaultTableModel) foodJTable.getModel();
        int selectedRow = foodJTable.getSelectedRow();
        Food foodSelected = (Food) dtm.getValueAt(selectedRow, 0);
        
        DoctorInstructionJPanel dwaj = new DoctorInstructionJPanel(container, patient, userAccount, organization, enterprise,  foodSelected, system, dB4OUtil);
        container.add(dwaj);
