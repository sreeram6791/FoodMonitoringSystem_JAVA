...
public class NurseWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public NurseWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, NurseOrganization organization, Enterprise enterprise, EcoSystem business, DB4OUtil dB4OUtil) {
    initComponents();
    ...
    public void populateRequestTable(){
        ...
        for(WorkRequest workRequest : business.getWorkQueue().getWorkQueue()){
            Object[] row = new Object[4];
            row[0] = workRequest;
            row[1] = workRequest.getFood().getName();
            row[2] = workRequest.getInstruction();
            row[3] = workRequest.getFeedback();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Click on Unattended Patient to Serve food");
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 360, 320, 50));
        ...
        add(Forward, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 370, -1, 30));
        ...
        jLabel2.setText("WorkRequests Log");
        ...
        historyJTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Patient Name", "Food", "Doctor Instruction", "Service Message"
            }
        ) {
    ...
    private void ForwardMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ForwardMouseReleased
        ...
        WorkRequest workRequest =  (WorkRequest) dtm.getValueAt(selectedRow,0);
        
        NurseServiceMessageJPanel nsmp = new NurseServiceMessageJPanel(container ,account, workRequest, organization, enterprise,  business, dB4OUtil);
        container.add(nsmp);
